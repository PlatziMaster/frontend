...
export default function Academic() {
    return (
        <div>
            ...
            <strong className="experience__title">Escuela Politécnica Ing. Jorge Matute Remus <br /></strong>
            ...
            <strong className="experience__title">Platzi <br /></strong>
            <span className="experience__date">Frontend, English, Software Development | Sep 2019 - Actualidad</span>
            <p className="text">Soy un estudiante de la plataforma de educación online Platzi.
En donde he aprendido sobre Desarrollo Web, programación, Inglés y también he desarrollado algunas habilidades blandas.</p>
