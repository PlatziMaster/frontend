  ...
  return (
        <section className=" education-card_container">
          <h2 className="education-card--title cards--title">
            <span className="book-icon "><i className="fa fa-book" aria-hidden="true"></i>
              </span>EDUCATION
          </h2>
      {
        academic?.map(aca => (
          <article key={aca.location} className="education-card__details--container">
              ...
              <p className="education-card__info--description">{aca.description}</p>
                </div>
            </article>
        ))
            }
