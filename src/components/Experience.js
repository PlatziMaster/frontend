...
export default function Experience() {
  return (
    <div>
      ...
      <p className='text'>
        Creación de portafolio personal, en el que utilizo herramientas como HTML, CSS y JavaScript, Git y GitHub, Figma (Para el diseño y prototipado) y la terminal de linux.
        <a className='experience__link' href='https://brandonargel.github.io/'> brandonargel.github.io</a>
        {' '}
        En este portafolio encontrará todos los proyectos que he realizado a lo largo de mi carrera.
      </p>
